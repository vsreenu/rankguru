...
public abstract interface ShowArticleDao
{
  ...
  public abstract void addArticleTypes(Session paramSession, ArticleTypes paramArticleTypes);
  ...
  public abstract void addRole(Session paramSession, Role paramRole);
  
  public abstract List<Role> viewRole(Session paramSession);
  
  public abstract void removeRole(Session paramSession, int paramInt);
  
  public abstract void addRoleUser(Session paramSession, RoleUserMapping paramRoleUserMapping);
  ...
  public abstract void addRoleArticle(Session paramSession, RoleArticleMapping paramRoleArticleMapping);
...
/* Location:              F:\addham\ROOT\WEB-INF\classes\!\com\sree\tali\dao\homepage\impl\ShowArticleDao.class
