...
if(uploadimagepojo.getArticleType().contains("SUB")|| uploadimagepojo.getDescription().contains("Sub_Article"))
{ %>
      <tr>
        <td ><font COLOR="#8A0829" style="font-size:21px"><div class="Gidugu">&#10153; <a href="<%=request.getContextPath()%>/titles/<%=uploadimagepojo.getUrl()%>" style="text-decoration: none"><%=uploadimagepojo.getTitle()%></a> </div></font></td>
  </tr>
<%
}else{
%>
    <tr>
        <td ><font COLOR="#8A0829" style="font-size:21px"><div class="Gidugu">&#10153; <a href="<%=request.getContextPath()%>/user/<%=uploadimagepojo.getArticleType()%>/<%=uploadimagepojo.getUrl()%>" style="text-decoration: none"><%=uploadimagepojo.getTitle()%></a> </div></font></td>
  </tr>
    <%
      }
       }
