...
function submitForm()
{
document.forms[0].action = "<%=request.getContextPath()%>/HomePageAction.do?method=uploadHome"
...
<html:form action="HomePageAction" method="post" enctype="multipart/form-data">
<table border = "0" width="800">
<tr><td align="center"></td><td></td></tr>
		<tr>	<td align="center">	Folder Name : </td><td><html:text property = "folderName"/></td></tr>
