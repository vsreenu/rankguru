...
for(UserPojo userpojo : userpojolist){
    ...
    <tr><td><%=userpojo.getUserName()%></td><td><%=userpojo.getStatus()%></td><td><a href="<%=request.getContextPath()%>/uploadimages.do?method=inactivateUser&&id=<%=userpojo.getId()%>">delete</a></td></tr>
