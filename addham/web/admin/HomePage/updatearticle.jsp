...
function addRow() {
   ...
   // alert("Hi");
	...
	var row = '<input name="image" type="file" value="" id = "rowNum'+rowNum+'" /> <input type="button" id ="delBut'+rowNum+'" value="Remove" onclick="removeRow('+rowNum+');"/>';
...
function submitForm()
{
document.forms[0].action = "<%=request.getContextPath()%>/uploadimages.do?method=updateArticle"
document.forms[0].submit();
}
function onChange()
{
document.forms[0].action = "<%=request.getContextPath()%>/uploadimages.do?method=getSubfolders"
document.forms[0].submit();
}
</script>
</head>
...
<tr><td align="center">	Article Type : </td><td>
     <html:select property="articleType" >
          <html:option value="">select</html:option>
         <html:options name="uploadimagepojo" property="articlList" />
     </html:select></td></tr>
<!-- <tr><td align="center">	Sub Article Type : </td><td>
     <html:select property="articleSubType" >
          <html:option value="">select</html:option>
         <html:options name="uploadimagepojo" property="subArticleList" />
     </html:select></td></tr> -->
<tr><td align="center">	Directory Name: </td><td><html:text property = "directoryname"/></td></tr>
<tr><td align="center">	Meta Data: </td><td><html:text property = "metaData"/></td></tr>
...
<tr><td align="center">	Article Number: </td><td><html:text property = "articleNumber"/></td></tr>
<tr><td align="center" width="50%"></td><td><br /></td></tr>

<tr><td align="right" style="margin:20px"><html:button property = "button" value = "update" onclick="submitForm()">Submit</html:button> </td></tr>

<html:hidden property = "id"/>
<html:hidden property = "filPath"/>
