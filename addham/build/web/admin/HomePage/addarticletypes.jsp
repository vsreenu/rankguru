...
function submitForm()
{
document.forms[0].action = "<%=request.getContextPath()%>/uploadimages.do?method=saveArticleType"
...
<tr><td align="center">	Article Type Name: </td><td><html:text property = "articleType"/></td></tr>
