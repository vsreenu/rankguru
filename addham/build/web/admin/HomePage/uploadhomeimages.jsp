...
function submitForm()
{
document.forms[0].action = "<%=request.getContextPath()%>/uploadimages.do?method=uploadImages"
...
<div id="insideadminbox1">
    <html:form action="uploadimages" method="post" acceptCharset="UTF-8" enctype="multipart/form-data">
...
<tr><td align="center">	Article Image : </td><td id ="itemRows"><html:file property = "articleImage"/> </td></tr>
