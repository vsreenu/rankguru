...
function submitForm()
{
document.forms[0].action = "<%=request.getContextPath()%>/uploadimages.do?method=roleArticleMapping"
...
<tr><td align="center">	Article  : </td><td>
     <html:select property="role_article" >
          <html:option value="">select</html:option>
         <html:options name="uploadimagepojo" property="role_article_list" />
     </html:select></td>
</tr>
